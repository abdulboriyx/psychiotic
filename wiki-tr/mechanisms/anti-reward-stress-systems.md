...
- **Çapraz durum bağlantısı:** CRF depresyonda disregüle edilir — duyarlı farelerde PVN'deki *Crf* promotöründe azalmış DNA metilasyonu CRF ve HPA ekseni hiperactivitesini artırır. (Bkz. [Depresyon](../conditions/depression.md); [DNA Metilasyonu](dna-methylation.md).)
...
- *Nr3c1* (glukokortikoid reseptörü) ve CRF lokuslarındaki stres kaynaklı epigenetik değişiklikler, bağımlılık ve depresyon arasında örtüşür. (Bkz. [DNA Metilasyonu](dna-methylation.md); [Epigenetik Düzenleme](epigenetic-regulation.md).)
...
- Mekanizmalar: [Dopamin Ödül Sistemi](dopamine-reward-system.md) · [Yürütücü İşlev Disregülasyonu](executive-function-dysregulation.md) · [DNA Metilasyonu](dna-methylation.md) · [Epigenetik Düzenleme](epigenetic-regulation.md)
- Kaynaklar: [Koob & Volkow 2016](../sources/koob-volkow-2016-neurobiology-addiction.md) · [Nestler ve ark. 2016](../sources/nestler-2016-epigenetic-basis-mental-illness.md)
