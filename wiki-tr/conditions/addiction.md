...
- **ΔFosB birikimi:** Sürekli transkripsiyon faktörü anahtarı; tekrarlanan kullanımla ilaç duyarlılığını artırır. (Ayrıca bkz. [Depresyon](depression.md) — NAc'de ΔFosB manipülasyonu depresif davranışla ilişkilendirilmiştir.)
- **Histon modifikasyonları (kokain):** Kromatin imzaları pre-mRNA eklemesini değiştirir; koşullu yer tercihi için gereklidir. (*Bkz. [Histon Modifikasyonları](../mechanisms/histone-modifications.md).*)
...
- Mekanizmalar: [Dopamin Ödül Sistemi](../mechanisms/dopamine-reward-system.md) · [Anti-Ödül ve Stres Sistemleri](../mechanisms/anti-reward-stress-systems.md) · [Yürütücü İşlev Disregülasyonu](../mechanisms/executive-function-dysregulation.md) · [Histon Modifikasyonları](../mechanisms/histone-modifications.md) · [Epigenetik Düzenleme](../mechanisms/epigenetic-regulation.md)
- Durumlar: [Depresyon](depression.md) — paylaşılan CRF/HPA ekseni katılımı; ΔFosB örtüşmesi
- Tartışmalar: [Bağımlılık Beyin Hastalığı mıdır?](../debates/addiction-as-brain-disease.md)
