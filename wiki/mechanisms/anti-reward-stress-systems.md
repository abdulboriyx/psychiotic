...
- **Cross-condition link:** CRF is dysregulated in depression — decreased DNA methylation at the *Crf* promoter in PVN in susceptible mice increases CRF and HPA-axis hyperactivity. (See [Depression](../conditions/depression.md); [DNA Methylation](dna-methylation.md).)
...
- Stress-induced epigenetic changes at *Nr3c1* (glucocorticoid receptor) and CRF loci overlap across addiction and depression. (See [DNA Methylation](dna-methylation.md); [Epigenetic Regulation](epigenetic-regulation.md).)
...
- Conditions: [Addiction](../conditions/addiction.md) · [Depression](../conditions/depression.md)
- Mechanisms: [Dopamine Reward System](dopamine-reward-system.md) · [Executive Function Dysregulation](executive-function-dysregulation.md) · [DNA Methylation](dna-methylation.md) · [Epigenetic Regulation](epigenetic-regulation.md)
- Sources: [Koob & Volkow 2016](../sources/koob-volkow-2016-neurobiology-addiction.md) · [Nestler et al. 2016](../sources/nestler-2016-epigenetic-basis-mental-illness.md)
