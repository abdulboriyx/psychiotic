...
|---|---|---|
| Acetylation | Lysine (K) | Activating — opens chromatin |
...
- Increases spacing between nucleosomes → opens chromatin → promotes transcription
...
- Key marks:
  ...
  - **H3K9me2** — repressive; silences gene loci in NAc, implicated in depression and antidepressant action
  - **H3K9me3** — repressive; induced by stress at repetitive elements in hippocampus
  - **H3K27me3** — repressive; increased at *Rac1* in depression, suppresses *BDNF* in hippocampus
  - **H3K4me1/H3K4me2** — enhancer marks
...
Jenuwein & Allis (2001) proposed that the sum of histone modifications at a gene defines a specific epigenetic state. Evidence supports this concept but the code is highly complex and has not been fully deciphered. Notably, no single modification examined is deterministic — the same mark can have no effect or even opposite effects at different genes. (*Hypothesis; not yet resolved.*)
...
### Depression
- HDAC inhibition → antidepressant effects in NAc, hippocampus, amygdala, PFC (animal models)
...
- Repressive chromatin remodeling complex induced in NAc by defeat — also found in depressed human NAc postmortem
...
Most human studies rely on postmortem tissue — cell type heterogeneity, postmortem interval, and medication effects confound results. Nearly all histone modification data comes from bulk tissue, not cell-type-resolved assays.

## Links

- Mechanisms: [Epigenetic Regulation](epigenetic-regulation.md) · [DNA Methylation](dna-methylation.md)
...
- Treatments: [HDAC Inhibitors](../treatments/hdac-inhibitors.md)
- Debates: [Epigenetics: Causation vs. Correlation](../debates/epigenetics-causation-vs-correlation.md)
