...
Post-translational covalent modifications of histone N-terminal tails. See: [Histone Modifications](histone-modifications.md)

### 2. DNA Methylation
Addition of methyl groups to cytosine residues. See: [DNA Methylation](dna-methylation.md)
...
1. **Gene × Environment interactions:** Epigenetic mechanisms are the interface between genetic predisposition and environmental exposures (stress, trauma, toxins).
2. **Stability:** Epigenetic changes can be long-lasting (especially DNA methylation), explaining enduring effects of early life adversity.
...
| Epigenetic changes cause psychiatric disorders (not just correlate) | Contested — see [Debates](../debates/epigenetics-causation-vs-correlation.md) |
| Peripheral epigenetic marks reflect brain state | Contested — see [Debates](../debates/peripheral-vs-brain-epigenetics.md) |
