...
- **ΔFosB accumulation:** Sustained transcription factor switch; increases drug sensitivity with repeated use. (See also [Depression](depression.md) — ΔFosB manipulation in NAc linked to depressive behavior.)
- **Histone modifications (cocaine):** Chromatin signatures alter pre-mRNA splicing; necessary for conditioned place preference. (*See [Histone Modifications](../mechanisms/histone-modifications.md).*)
...
- Mechanisms: [Dopamine Reward System](../mechanisms/dopamine-reward-system.md) · [Anti-Reward and Stress Systems](../mechanisms/anti-reward-stress-systems.md) · [Executive Function Dysregulation](../mechanisms/executive-function-dysregulation.md) · [Histone Modifications](../mechanisms/histone-modifications.md) · [Epigenetic Regulation](../mechanisms/epigenetic-regulation.md)
- Conditions: [Depression](depression.md) — shared CRF/HPA axis involvement; ΔFosB overlap
- Debates: [Addiction as Brain Disease](../debates/addiction-as-brain-disease.md)
- Sources: [Koob & Volkow 2016](../sources/koob-volkow-2016-neurobiology-addiction.md)
